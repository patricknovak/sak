...
export const FEATURE_GROUPS: FeatureGroup[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'lineup-tools', icon: '⚙️', title: 'Lineup tools and auto-pilot', to: '/team', isNew: true, blurb: 'The best possible lineup for today, this week or the whole season, in one tap.',
        points: ['An exact optimizer: never wastes a dual-position player', 'Rank by projection, hot hand (last 14 days) or season average', 'Auto-pilot sets it every morning and again before puck drop', 'Pin players to always start or never start', 'Week planner shows everyone’s games day by day', 'Never overrides a move you made yourself that day'] },
      { key: 'players', icon: '🔍', title: 'Players, stats and pickups', to: '/players', isNew: true, blurb: 'Search every NHL player, slice the stats any way you like, add and drop.',
        points: ['Sort by any stat: goals, assists, PPP, shots, hits, blocks, wins, save % and more', 'Timeframes: projection, last season, this season, last 7 / 14 / 30 days', 'Per-game rates, hide injured, minimum games and NHL team filters, plus a full stats table', 'The same tools inside the draft room and the mock draft', '10 free pickups a season, then $30 each, tracked automatically'] },
      ...
      { key: 'standings', icon: '🏆', title: 'Standings and playoffs', to: '/standings', blurb: 'The race for the Johnson and away from the Peter.',
        points: ['Today, yesterday and last-7-days columns', 'Playoffs continue with the same rosters on a separate table', 'Regular season and playoffs each have their own pot'] },
    ],
  },
  {
    ...
    features: [
      ...
      { key: 'alerts', icon: '🔔', title: 'Phone alerts', to: '/profile', blurb: 'Buzzes for your draft turn, trade offers, mentions and big moments.',
        points: ['Works on iPhone once SaK is on your Home Screen', 'In-app notification bell as well'] },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'commish', icon: '🛠️', title: 'Commissioner tools', blurb: 'Everything Patrick needs to run the league.',
