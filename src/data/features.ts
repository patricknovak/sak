  ...
  },
  {
    ...
    features: [
      ...
      { key: 'nhl-hub', icon: '🏒', title: 'NHL hub: live scores, standings, highlights, radio', to: '/nhl', isNew: true, blurb: 'Every NHL game in one place, with your SaK players flagged in each one.',
        points: ['Live scores with period, clock and shots, refreshed every 30 seconds', 'Every goal with its highlight clip, plus the three-minute recap and condensed game, playing right on the page', 'Box scores with SaK owners marked, three stars, penalties', 'NHL standings by division, conference, wild card or league, with GMs’ favourite teams marked', 'The week’s schedule with broadcasters', 'News: NHL.com, Sportsnet and ESPN headlines in one feed, with filters for your players and roster moves, and SaK owners tagged on every story', 'Leaders: NHL leaderboards for every skater and goalie category, plus the hottest players in the SaK pool over the last 7 days', 'Teams: all 32 clubs with rosters, bios, this week’s games and every player’s season stats, SaK owners marked', 'Watch live: one tap to the right broadcaster for each game (Sportsnet, TSN, CBC Gem, TVA, ESPN, TNT/Max, Prime, NHL.tv), where you sign in with Telus, Rogers, Bell or your subscription; set your services on your profile and the games you can watch get flagged', 'Listen live: NHL team radio streams'] },
      { key: 'yahoo', icon: '🟣', title: 'Your other Yahoo leagues', to: '/yahoo', isNew: true, blurb: 'Sign in with Yahoo once and run every other Yahoo hockey league you play in or commission from SaK.',
        points: ['Every Yahoo Fantasy Hockey league you’re in: standings, your rank and record, week and scoring type', 'Matchups week by week, with category-by-category results in H2H leagues', 'Set your Yahoo lineup for any date, with who plays that night flagged and slot counts checked before you save', 'Free agents and waivers: search, filter by position, add, drop, claim (FAAB bids too)', 'Trades: propose, accept, reject or withdraw; commissioners approve or veto right here', 'Yahoo’s own sign-in (OAuth), so SaK never sees your Yahoo password; disconnect any time from your profile', 'Manage on Yahoo: the Yahoo window opens beside SaK (a new tab on a phone) already signed in, for lineups, pickups, trades, settings and commissioner tools when Yahoo only grants read access, or for anything the API doesn’t cover'] },
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'bets', icon: '🎲', title: 'Side bets and St. Patrick coins', to: '/bets', blurb: 'Put your coins, or real money, where your mouth is.',
        points: ['Everyone started with 1,000 St. Patrick coins', 'Head-to-head bets settle automatically on fantasy points', 'Open bets anyone can take', 'Garry pays out 25 coins to the Dangler of the Day and 50 to the Team of the Week', 'Real-money bets tracked in St. Patrick’s Bank until they’re settled'] },
