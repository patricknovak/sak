...
export const FEATURE_GROUPS: FeatureGroup[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { key: 'players', icon: '🔍', title: 'Players and pickups', to: '/players', blurb: 'Search every NHL player, see who’s available, add and drop.',
        points: ['Sort by projection, last season or this season', 'Injury badges everywhere', '10 free pickups a season, then $30 each, tracked automatically'] },
